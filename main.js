...
audioLoader.load("/astro-world/sounds/lemmings.mp3", function (buffer) {
...
const normalTexture = textureLoader.load("/astro-world/textures/NormalMap.png");

const loader = new GLTFLoader();
let obj;
let modelObj = [];
loader.load(
  "/astro-world/assets/scene.gltf",
  function (gltf) {
  ...
  if (found.length > 0) {
    if (found[0]) {
      ...
      if (objectName.includes("polySurface")) {
        ...
        audioLoader.load("/astro-world/sounds/dog_bark.mp3", function (buffer) {
        ...
        audioLoader.load("/astro-world/sounds/fairy.mp3", function (buffer) {
        ...
        audioLoader.load("/astro-world/sounds/banana.mp3", function (buffer) {
